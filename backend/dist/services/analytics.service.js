...
class AnalyticsService {
     ...
     */
    static async getStudentAnalytics(studentUserId) {
    ...
    static async getStudentAnalyticsByProfileId(studentId) {
        return await this.calculateAnalytics(studentId);
    }
    static async calculateAnalytics(studentId) {
        // In a real system, these would be heavily cached or read from materialized views.
        // 1. ACADEMIC METRICS
        const academicRes = await (0, db_1.query)(`
      SELECT 
        a.id, 
        a.max_marks, 
        a.weightage, 
    ...
    `, [studentId]);
        ...
        const attendanceRes = await (0, db_1.query)(`
    ...
    `, [studentId]);
        ...
        // 3. TASKS
        const tasksRes = await (0, db_1.query)(`
    ...
    `, [studentId]);
        ...
        // 4. GOALS
        const goalsRes = await (0, db_1.query)(`
    ...
    static async snapshotMetrics(studentId, data) {

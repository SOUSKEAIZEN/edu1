import { RiskThresholds } from './RiskRules';
...
export class RiskCalculator {
  static calculate(data: AnalyticsData, rules: RiskThresholds, version: string = 'v1') {
    let overallScore = 0;
    const factors: any[] = [];
    let confidence = 1.0;
    ...
    else if (overallScore > 40) level = 'ATTENTION';
    else if (overallScore > 20) level = 'MONITOR';
